...
const ComputerItem = ({computer}:Props) => {
    ...
    return(
        <tr key={computer.id_computer} className="hover:bg-blue-50/40">
            ...
            <span
                ...
                computer.status_computer === "Ativo"
            ...
            <td className="py-3 px-4">{computer.exit_date || "N/A"}</td>
            <td className="py-3 px-4">{computer.reason || "N/A"}</td>
            <td className="py-3 px-4">{computer.return_date || "N/A"}</td>
            ...
            {modalEdit && <ModalComputer isEditing={true} computer={computer} setModalEdit={setModalEdit}/>}
        </tr>
    )
}
