"use client";
// Este componente é client-side (necessário no app directory do Next.js)
...
const LoginBox = () => {
  ...
  // Estados controlados para capturar email e senha
          ...
          <div className="flex flex-col text-left">
            ...
            <input
               type="text"
                        ...
                        className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 border rounded-lg px-3 py-2 
